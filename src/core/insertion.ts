...
export class Insertion {
  ...
  private findExistingImport(programPath: NodePath<t.Program>): t.ImportDeclaration | null {
  ...
  private hasUseTranslationImport(importDeclaration: t.ImportDeclaration): boolean {
  ...
  private addUseTranslationToExistingImport(importDeclaration: t.ImportDeclaration): void {
